                    ...
                    <form class=" row mb-30" action="{{ route('feesInvoices.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="repeater">
                                    ...
                                    <div data-repeater-item>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input class="btn btn-danger btn-block" data-repeater-delete type="button" value="{{__('Delete row') }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-20">
                                    <div class="col-12">
                                        <input class="btn btn-secondary" data-repeater-create type="button" value="{{__('Add row')}}"/>
                                    </div>
                                </div><br>
