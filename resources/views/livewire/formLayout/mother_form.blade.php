        ...
        <div class="form-row">
            <div class="col">{{--يمين--}}
                ...
                <label for="title">{{__('name_mother_ar')}}</label><br>
            ...
            <div class="form-row">
                <div class="col">{{--يمين--}}
                    <div class="form-row">
                        <div class="col">
                    <label for="title">{{__('job_mother_ar')}}</label><br>
                ...
                <div class="col">
                    <label for="title">{{__('job_mother_en')}}</label><br>
            ...
            <div class="form-row">
                <div class="col">
                    <label for="title">{{__('parents_attachment')}}</label><br>
                ...
                <div class="col">
                    ...
                    <div class="form-row">
                    <div class="col">
                        <label for="title">{{__('blood_Type_mother_id')}}</label><br>
            ...
            <label for="title">{{__('address_mother')}}</label><br>
