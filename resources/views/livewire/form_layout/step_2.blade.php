...
@endif
    ...
    @if ($addMode)
        <button style="background: #72ab2a;color:white" class="btn btn-sm nextBtn btn-lg mt-3" wire:click="secondStepSubmit"
            type="button">{{ __('Next') }}</button>
    @else
        <button style="background: #72ab2a;color:white" class="btn btn-sm nextBtn btn-lg mt-3"
            wire:click="secondStepSubmitEdit" type="button">{{ __('Next') }}</button>
    @endif
