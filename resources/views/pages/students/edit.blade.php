    ...
    <form action="{{route('Students.update','test')}}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input value="{{$student->date_of_birth}}" class="form-control" type="text" id="datepicker-action"
                       name="date_of_birth" data-date-format="yyyy-mm-dd">
            </div>
        </div>
        <div class="form-row">
                ...
                <div class="form-row">
                    <div class="form-group col">
                        ...
                        <select name="nationality_id" class="custom-select">
                            ...
                            <option value="{{$student->nationalities->id}}"
                                    selected>{{$student->nationalities['name_'.app()->getLocale()]}}</option>
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <select name="parent_id" class="custom-select">
                            <option value="{{$student->parents->id}}"
                                    selected>{{$student->parents['name_father_'.app()->getLocale()]}}</option>
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <select name="grade_id" class="custom-select">
                            <option value="{{$student->grades->id}}"
                                    selected>{{$student->grades['name_'.app()->getLocale()]}}</option>
                    ...
                    <div class="col">
                        ...
                        <select name="classroom_id" class="custom-select">
                            <option value="{{$student->classrooms->id ?? ''}}"
                                    selected>{{$student->classrooms['name_'.app()->getLocale()]??''}}</option>
                        </select>
                    </div>
                    <div class="col">
                        ...
                        <select name="section_id" class="custom-select">
                            <option value="{{$student->sections->id??''}}"
                                    selected>{{$student->sections['name_'.app()->getLocale()]??''}}</option>
                        </select>
                    </div>
                </div>
                <br>
            ...
            <div class="col">
                <div class="form-row">
                    ...
                    <select name="religion_id" class="custom-select">
                        <option value="{{$student->religions->id}}"
                                selected>{{$student->religions['name_'.app()->getLocale()]}}</option>
