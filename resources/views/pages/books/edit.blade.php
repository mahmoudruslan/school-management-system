                    ...
                    <form method="post" action="{{route('books.update', $book->id)}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputState">{{__('Books Name_ar')}} : <span
                                    class="text-danger">*</span>
                                </label><br>
                                @error('name_ar') <span class="error text-danger">{{ $message }}</span> @enderror
                                <input type="text" value="{{$book->name_ar}}" name="name_ar" class="form-control">
                            </div>
                            <div class="form-group col">
                                <label for="Classroom_id">{{__('Books Name_en')}} : <span
                                        class="text-danger">*</span></label><br>
                                @error('name_en') <span class="error text-danger">{{ $message }}</span> @enderror
                                <input type="text" value="{{$book->name_en}}" name="name_en" class="form-control">
                            </div>
                        </div><br>
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="grade_id">
                                    <option value="{{$book->grade_id}}">{{$book->grades['name_'.app()->getLocale()]}}</option>
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="classroom_id" >
                                    <option value="{{$book->classroom_id}}">{{$book->classrooms['name_'.app()->getLocale()]}}</option>
                                </select>
                            </div>
                            <div class="form-group col">
                                ...
                                <select name="teacher_id" class="custom-select">
                                    <option value="{{$book->teacher_id}}">{{$book->teachers['name_'.app()->getLocale()]}}</option>
