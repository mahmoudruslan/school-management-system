                    ...
                    <form method="post" action="{{route('roles.update',$role->id)}}">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <input type="text" name="name_ar" value="{{$role->name_ar}}" class="form-control">
                            </div>
                            <div class="form-group col">
                                ...
                                <input type="text" name="name_en" value="{{$role->name_en}}" class="form-control">
                            </div>
                        </div><br>
                        <div class="form-group col">
                            <div class=" col-md-12">
                                    ...
                                    <div class="mr-5 d-inline">
                                        ...
                                        <input class="form-check-input" {{in_array($name,$role->permissions) ? 'checked' : ''}} name="permissions[]" type="checkbox" value="{{$name}}" id="flexCheckChecked">
