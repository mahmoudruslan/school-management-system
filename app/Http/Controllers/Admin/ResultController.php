...
class ResultController extends Controller
{
    ...
    {
        $grades = $g->getData();
        return view('admin_dashboard.pages.results.create', compact(['grades', 'teacher_id']));
    }
    ...
    public function create2(Request $request, StudentsRepositoryInterface $s, SubjectsRepositoryInterface $sub)
    {
        ...
        return view('admin_dashboard.pages.results.create2', compact(['students', 'subjects', 'teacher_id']));
    }
    ...
    public function show($student_id, ResultsRepositoryInterface $r, StudentsRepositoryInterface $s, StudentAccountsRepository $s_a)
    {
        ...
        return view('admin_dashboard.pages.students.result', compact(['student_result', 'classrooms', 'credit', 'debit']));
    }
